...
class Ui_Login_Form2(QtWidgets.QWidget):
    def setupUi(self):
        self.InicioDSesion_label = QtWidgets.QLabel(Login_Form)
        self.InicioDSesion_label.setGeometry(QtCore.QRect(300, 220, 200, 20))
        font = QtGui.QFont()
        ...
        self.Registrar_pushButton.setObjectName("Registrar_pushButton")
        self.verticalLayout.addWidget(self.Registrar_pushButton)
        #self.InicioDSesion_label.setText(("Login_Form", "Inicio de sesion "))
        #self.Correo_lineEdit.setPlaceholderText(("Login_Form", "Correo"))
        #self.Contrasena_lineEdit.setPlaceholderText(("Login_Form", "Contrasena"))
        #self.Ingresar_pushButton.setText(("Login_Form", "Ingresar"))
        #self.Registrar_pushButton.setText(("Login_Form", "Registrar"))
